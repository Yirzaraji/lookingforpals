...
<meta name="viewport" user-scalable="yes" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">

<!--<link type="text/css" rel="stylesheet" media="all" href="/arrowchat/public/list/css/style.css" charset="utf-8" /> 
				...
				<div class="eight columns">
					<div class="contain-to-grid<?php if (sq_option('sticky_menu', 1) == 1) echo ' sticky'; ?>">
						<nav class="top-bar">
							...
							<?php if( is_user_logged_in()) { ?><!-- php if logged -->
							<div class="kleo-notifications2">
							<a href="http://www.lookingforpals.com/my-messages-bis/"><?php bp_total_unread_messages_count() ?></a>
							</div>
